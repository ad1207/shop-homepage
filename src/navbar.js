            ...
            <Navbar expand="lg" variant="light" bg="light">
                <Container className="px-4 px-lg-5">
                    ...
                    <Navbar.Collapse id="basic-navbar-nav">
                        ...
                        <Button variant="outline-dark"><span className="px-1"><CartFill size={20}/></span>Cart<span className='badge bg-dark text-white ms-1 rounded-pill'><>{getValue.cart}</></span> </Button>
                    </Navbar.Collapse>
